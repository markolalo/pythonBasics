"""Fibonacci Sequence, by Al Swegart al@inventwithpython.com
...
The sequence begins with 0 and 1, and the next number is the
...
while True: # Main program loop
    ...
    if nth >= 10000:
        ...
        print('screen. If you want to quit this before it is0')
    ...
    print('0, 1, ', end='') #Display the first two Fibonnaci numbers.
